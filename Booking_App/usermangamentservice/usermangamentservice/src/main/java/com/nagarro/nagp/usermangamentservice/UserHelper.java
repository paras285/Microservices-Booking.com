...
public class UserHelper {
	...
	public UserHelper() {
		User user1 = new User("1","rahul@gmail.com", "Rahul", "Arora", "Jalandhar", 9876543210L);
		User user2 = new User("2","neha@gmail.com", "Neha", "Arora", "Jalandhar", 9876543210L);
		User user3 = new User("3","paras@gmail.com", "Paras", "Arora", "Jalandhar", 9876543210L);
		User user4 = new User("4","megha@gmail.com", "Megha", "Arora", "Jalandhar", 9876543210L);
		User user5 = new User("5","shivani@gmail.com", "Shivani", "Arora", "Jalandhar", 9876543210L);
		userList.add(user1);
		userList.add(user2);
		userList.add(user3);
		userList.add(user4);
