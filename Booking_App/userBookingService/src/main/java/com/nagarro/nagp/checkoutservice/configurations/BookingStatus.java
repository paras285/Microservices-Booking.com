...
public class BookingStatus {
	...
	private String flightUnavailability;
	
	public String getFlightUnavailability() {
		return flightUnavailability;
	}

	public void setFlightUnavailability(String flightUnavailability) {
		this.flightUnavailability = flightUnavailability;
	}
